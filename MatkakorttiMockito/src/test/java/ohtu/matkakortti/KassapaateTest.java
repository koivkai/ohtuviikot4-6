...
public class KassapaateTest {
    ...
    @Test
    public void rahanlataaminenPositiivisellaSummallaKutsuuKortinLaataaMetodia() {
    ...
    @Test
    public void rahanlataaminenNegattivisesllaSummallaEIKutsuKortinLaataaMetodia() {
        kassa.lataa(kortti, -10);
        
        verify(kortti, never()).lataa(-10);
    }
